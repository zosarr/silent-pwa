...
window.addEventListener('DOMContentLoaded', () => {
  // ===== Sblocco Audio su primo gesto utente =====
  function unlockAudioOnce(){
    try{
      ...
      // emetti un bip brevissimo per "sbloccare" l'audio su iOS
  ...
  document.addEventListener('pointerdown', unlockAudioOnce, { once:false, passive:true });

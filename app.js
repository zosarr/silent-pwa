...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function manualDisconnect(){
    ...
    // reset crypto/session so si possano reinserire chiavi & fingerprint
    try { clearKeyCache(); } catch(_) {}
  ...
  if (els.disconnectBtn){
    els.disconnectBtn.addEventListener('click', manualDisconnect);
  }
// === Fingerprint UI ===

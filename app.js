...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function onIncoming(kind){
    if (document.hidden) {
      ...
      // showNotif già esistente: usa icon ./icons/notify.png e nessun badge
      try{ showNotif('Silent', kind==='text' ? 'Nuovo messaggio' : (kind==='image' ? 'Nuova foto' : 'Nuovo audio')); }catch(_){}
    }
  }
  ...
  // Delegated click handler (robusto)

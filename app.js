  ...
  async function showNotif(title, body){
    try{
      ...
      if (Notification.permission === 'granted') {
        ...
        if (reg && reg.showNotification) await reg.showNotification(title, { body, icon: './icons/1.png', tag: 'silent-new-msg' });
        else new Notification(title, { body, icon: './icons/1.png', tag: 'silent-new-msg' });
      }

...
export class E2E {
  static toB64(buf){ return btoa(String.fromCharCode(...new Uint8Array(buf))); }
  static fromB64(b64){ return Uint8Array.from(atob(b64), c=>c.charCodeAt(0)); }
